...
From the visualisation below, we can see that respondents in the 65 to 99 year ols age group have longer 95% confidence interval lines compared to across all age groups. This could be because there are comparatively less respondents from this particular age group. Males in this age category tend to be less concerned about side effects than females. </br>![](images/cifor65andabove.jpg){width=100%}</br>
