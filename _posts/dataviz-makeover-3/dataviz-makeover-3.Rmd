...
description: |
  This visualisation surfaces the most common and deadliest armed conflicts in Southeast Asia, from 2010 to 2020.</br></br>The visualisation can be seen [here](https://public.tableau.com/profile/andywong#!/vizhome/DataVizMakeover3ArmedconflictinSoutheastAsia/GeolocationofarmedconflictinSoutheastAsia).
